...
class MagicChatConversationRepository implements MagicChatConversationRepositoryInterface
{
     ...
     */
    public function getConversationsByUserId(MagicConversationEntity $conversation, ConversationListQueryDTO $queryDTO): array
    {
        return $this->getConversationsByUserIds($conversation, $queryDTO, [$conversation->getUserId()]);
    }

    /**
     * @return MagicConversationEntity[]
     */
    public function getConversationsByUserIds(MagicConversationEntity $conversation, ConversationListQueryDTO $queryDTO, array $userIds): array
    {
