...
namespace App\Domain\Authentication\Repository\Persistence\Filter;
...
{
    public function addIsolationOrganizationCodeFilter(Builder $builder, AuthenticationDataIsolation $dataIsolation, string $alias = 'organization_code'): void
    {
    ...
    public function addIsolationEnvironment(Builder $qb, AuthenticationDataIsolation $dataIsolation, string $alias = 'environment'): void
    {
        if (! $dataIsolation->isEnable()) {
            return;
        }
