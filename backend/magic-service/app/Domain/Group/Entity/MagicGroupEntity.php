...
final class MagicGroupEntity extends AbstractEntity implements ArrayAccess
{
    protected string $id = '';
    ...
    public function setGroupType(GroupTypeEnum|int $groupType): void
    {
        if (is_int($groupType)) {
            $groupType = GroupTypeEnum::from($groupType);
        }
    ...
    public function setGroupStatus(GroupStatusEnum|int $groupStatus): void
    {
        if (is_int($groupStatus)) {
            $groupStatus = GroupStatusEnum::from($groupStatus);
        }
