...
class ToolDetail(BaseModel):
    ...
    data: Union[
        ...
        ScriptExecutionContent, ReasoningContent, AskUserContent, Dict[str, Any]
    ]  # 展示内容，根据type动态展示
...
class ServerMessagePlayload(BaseModel):
    """任务消息模型"""
...
class ServerMessage(BaseModel):
    ...
    payload: ServerMessagePlayload

    @classmethod
    def create(cls, metadata: Dict[str, Any], payload: ServerMessagePlayload) -> "ServerMessage":
