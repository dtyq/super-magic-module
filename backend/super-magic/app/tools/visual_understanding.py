...
class VisualUnderstanding(BaseTool[VisualUnderstandingParams]):
    ...
    # 设置参数类
    params_class = VisualUnderstandingParams

    # 设置工具元数据
    name = "visual_understanding"
    description = """视觉理解工具，用于分析和解释图像内容。
...
```
{
    "images": ["./downloads/image1.jpg", "./downloads/image2.jpg"],
