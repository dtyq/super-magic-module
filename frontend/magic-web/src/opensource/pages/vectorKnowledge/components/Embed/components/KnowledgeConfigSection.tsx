			...
			<div>
					...
					<>
						<div className={styles.configItem}>
							...
							<div className={styles.configValue}>
								{fragmentConfig.normal?.segment_rule?.chunk_size || "-"} Tokens
							</div>
						</div>
						...
						<div className={styles.configItem}>
							...
							<div className={styles.configValue}>
								{fragmentConfig.normal?.segment_rule?.chunk_overlap || "-"} Tokens
							</div>
						</div>
						...
						<div className={styles.configItem}>
							...
							<div className={styles.configValue}>
								{fragmentConfig.normal?.segment_rule?.separator || "-"}
							</div>
						</div>
				...
				{retrieveConfig?.score_threshold_enabled && (
					<div className={styles.configItem}>
						...
						<div className={styles.configValue}>
							{retrieveConfig?.score_threshold || "-"}
						</div>
					</div>
				)}
				...
				{retrieveConfig?.reranking_enable && (
					<div className={styles.configItem}>
						...
						<div className={styles.configValue}>
							{retrieveConfig?.reranking_model.reranking_model_name || "-"}
						</div>
					</div>
				)}
			</div>
