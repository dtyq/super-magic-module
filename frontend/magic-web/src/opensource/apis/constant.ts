...
export const enum RequestUrl {
	...
	/** 更新片段 */
	updateFragment = "/api/v1/knowledge-bases/${knowledge-base-code}/documents/${document-code}/fragments/${id}",
	/** 片段列表 */
	getFragmentList = "/api/v1/knowledge-bases/${knowledge-base-code}/documents/${document-code}/fragments/queries",
	/** 片段详情 */
	getFragmentDetail = "/api/v1/knowledge-bases/${knowledge-base-code}/documents/${document-code}/fragments/${id}",
	/** 片段删除 */
	deleteFragment = "/api/v1/knowledge-bases/${knowledge-base-code}/documents/${document-code}/fragments/${id}",
	/** 知识库重建 - 待废弃 */
	...
	/** 获取用户个人机器人列表 */
	getUserBotList = "/api/v1/agents/user",
	/** 保存机器人 */
	...
	/** 获取日程纪要 */
	getCalendarSummary = "/api/v1/schedules/${id}",
	/** 评论日程 */
