...
return [
    ...
    'descriptions' => [
        ...
        'designing-canvas-images' => 'Canvas（画布）项目管理技能，提供 AI 图片生成、网页图片搜索和设计标记处理能力。会在所有图片生成任务中自动使用，用于统一组织和管理图片。支持图生图生成与设计标记处理。仅当用户明确要求不要使用画布，或操作对象是在网页、PPT 等其他应用中的图片时才跳过。重要：当用户消息中包含 [@design_canvas_project:...] 或 [@design_marker:...] 提及时，必须在执行任何操作前优先加载此技能。',
